...
3. [Project Structure](#project-structure)
    ...
    2. [Documentation Details](#documentation-details)
        1. [Specification (`ModuleName_spec`)](#1-specification-modulename_spec)
            ...
            2. [Configuration Parameters](#12-configuration-parameters)
            3. [Interface](#13-interface)
                1. [Signal List](#131-signal-list)
                2. [Timing Diagrams](#132-timing-diagrams)
                3. [Protocol Definitions](#133-protocol-definitions)
            4. [Register Map](#14-register-map)
                1. [Register Description Table](#141-register-description-table)
                2. [Field Details](#142-field-details)
            5. [Micro-Architecture](#15-micro-architecture)
                1. [Module Decomposition Tree (Functional Hierarchy)](#151-module-decomposition-tree-functional-hierarchy)
                2. [Block Diagrams & Sub-module Partitioning](#152-block-diagrams--sub-module-partitioning)
                3. [Key FSM Descriptions](#153-key-fsm-descriptions)
                4. [Data Flow Paths](#154-data-flow-paths)
                5. [Error Handling](#155-error-handling)
            6. [Clock & Reset](#16-clock--reset)
            7. [Integration & Usage](#17-integration--usage)
        2. [Implementation Guide (`ModuleName_impl_guides`)](#2-implementation-guide-modulename_impl_guides)
            1. [Design Rationale](#21-design-rationale)
            2. [Structural & Micro-Architectural View](#22-structural--micro-architectural-view)
            3. [Sub-Module Implementation Details](#223-sub-module-implementation-details)
            4. [Key FSM & Control Logic](#224-key-fsm--control-logic)
            5. [Coding Specifics & Parameters](#225-coding-specifics--parameters)
            6. [Handling Corner Cases](#226-handling-corner-cases)
            7. [Verification & Debug Support](#227-verification--debug-support)
            8. [Optimization Record](#228-optimization-record)
            9. [Performance Analysis](#229-performance-analysis)
            10. [Known Issues & Roadmap (TODOs)](#2210-known-issues--roadmap-todos)
